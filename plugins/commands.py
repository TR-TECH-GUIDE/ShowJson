...
async def start(c, m):
    ...
    owner_username = owner.username if owner.username else 'SLBotsOfficial'
...
"""
    ...
    buttons = [
        [
            InlineKeyboardButton('My Developer 👨‍✈️', url=f"https://t.me/{owner_username}")
        ],
        [
            InlineKeyboardButton('Bot Updates', url=f"https://t.me/TharukRenuja")
        ]
    ]
    await m.reply_text(
        text=text,
